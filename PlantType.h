...
public:
     ...
     */
    PlantType(const std::string &n, double p, const std::string &desc, const std::string &colourType);

    /**
     * @brief Constructs a PlantType with initial properties, color, and season
     *
     * @param n The name of the plant
     * @param p The price of the plant
     * @param desc The description of the plant
     * @param colourType Initial color type for the plant
     * @param season The season for the plant
     */
     ...
     *
     * @param other The PlantType object to copy from
     */
